...
export default function AskGrik() {
  const { user } = useAuth();
  ...
  useEffect(() => {
    ...
    async function loadContext() {
      ...
      try {
        const [profileRes, visionRes] = await Promise.all([
          api.profileDetails() as Promise<ProfileDetails>,
  ...
  return (
    <section className="farmer-page ask-grik-page">
      ...
      <div className="grik-layout grik-layout-solo">
